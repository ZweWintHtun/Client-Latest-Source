...
{
    public partial class LOMVEW00430 : BaseDockingForm, ILOMVEW00430
    {
        #region Properties
        ...
        private ILOMCTL00430 controller;
        public ILOMCTL00430 Controller
        {
            set
            {
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            ...
            remove = "1"; // Approve
            string result=this.Controller.SaveBlackListsRemove();
            if (result == "000")
            {
        ...
        private void LOMVEW00430_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        public void InitializeControls()
        {
            ...
            idArray = "";
            BlackListsData = this.Controller.SelectAllBlackListsForRemove();
