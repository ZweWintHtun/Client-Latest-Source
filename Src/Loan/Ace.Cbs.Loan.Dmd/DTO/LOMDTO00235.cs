...
{
    [Serializable]
    public class LOMDTO00235 : EntityBase<LOMDTO00235>
    {
        public LOMDTO00235() { }

        public LOMDTO00235(string eno,string status,string desp,string narration,string acctNo,string resAcctNo,decimal amount,string headACName, string aCode,
