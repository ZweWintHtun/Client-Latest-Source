    ...
    public class Income_Expense_Excel
    {
      ...
      )
        {
            try
            {
                ...
                rng01 = myworksheet1.get_Range("A5:E5");
                rng01.MergeCells = true;
                rng01.Value = "(Kyats)";
                rng01.EntireRow.Font.Name = "Times New Roman";
                rng01.EntireRow.Font.Size = 13;
                ...
                rng01 = myworksheet1.get_Range("A8:E8"); rng01.Borders.Color = System.Drawing.Color.Black.ToArgb();

                rng01 = myworksheet1.get_Range("A6:E7");
                ...
                rngSubTotal = myworksheet1.get_Range(GetExcelColumnName(1) + ":" + GetExcelColumnName(5));
                ...
                rng01 = Expenditure_sheet2.get_Range("C2:E2");
                rng01.MergeCells = true;
                rng01.Value = "Pristine Global Finance Company Limited.";
                rng01.Font.Size = 13;
                rng01.EntireRow.Font.Name = "Times New Roman";
                ...
                rng01 = Expenditure_sheet2.get_Range("C3:E3");
                rng01.MergeCells = true;
                rng01.Font.Size = 13;
                rng01.EntireRow.Font.Name = "Times New Roman";
                rng01.EntireRow.Font.Bold = true;
                ...
                rng01 = Expenditure_sheet2.get_Range("A6:E7");
                rng01.Borders.Color = System.Drawing.Color.Black.ToArgb();
                rng01.HorizontalAlignment = XlHAlign.xlHAlignCenter;
                rng01.VerticalAlignment = XlVAlign.xlVAlignCenter;
                ...
                rng01 = Expenditure_sheet2.get_Range("A5:E5");
                rng01.MergeCells = true;
                rng01.Value = "(Kyats)";
                rng01.Font.Size = 13;
                rng01.EntireRow.Font.Name = "Times New Roman";
                ...
                AllColumn = Expenditure_sheet2.get_Range("A8:E8");
                ...
                rng01 = Expenditure_sheet2.get_Range("B:E");
                rng01.ColumnWidth = 18;
                ...
                rngSubTotal = Expenditure_sheet2.get_Range(GetExcelColumnName(1) + ":" + GetExcelColumnName(6));
                rngSubTotal.EntireColumn.AutoFit();
        ...
        private void AddSubTotal(int sheet, string para_TitleName)
        {
            ...
            else if (sheet == 2)
            {
                ...
                sheet2_SumSubTotal_E += _sumTotalColumn_For_E;//ZMS
