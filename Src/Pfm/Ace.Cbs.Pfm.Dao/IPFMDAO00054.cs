...
namespace Ace.Cbs.Pfm.Ctr.Dao
{
    public interface IPFMDAO00054 : IDataRepository<PFMORM00054>
    {
        ...
        IList<PFMDTO00054> GetTlfInfoByEntryNoANDGroupNo(string groupNo, string eno, string sourceBr);// Added By HMW (29-May-2019) : Multiple Withdraw and Deposit Reversal) For Seperating EOD  
    }
}
