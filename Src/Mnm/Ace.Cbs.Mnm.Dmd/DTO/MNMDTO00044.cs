...
{
    [Serializable]
    public class MNMDTO00044 : EntityBase<MNMDTO00044>
    {
        public MNMDTO00044() { }

         public MNMDTO00044(string acctno,string name,decimal fbal,decimal budendacc,decimal duration,DateTime rdate,DateTime wdate,DateTime lastintdate,decimal amount,string rno,decimal accured,decimal draccured,string sourcbr,string cur)
        {
            this.AcctNo = acctno;
            this.Name = name;
            this.Fbal = fbal;
