...
namespace Ace.Cbs.Loan.Dmd.DTO
{
    ...
    public class LOMDTO00208 : EntityBase<LOMDTO00208>
    {
        ...
        public LOMDTO00208(string hpNo, string acctNo, string name, decimal loanAmount, decimal outstandingBal, DateTime createdDate, DateTime expDate, string stockGroup)
        {
            HPNo = hpNo;
            Caccount = acctNo;
            NAME = name;
