...
{
    public partial class LOMVEW00440 : BaseForm , ILOMVEW00440
    {
       #region Constructor
        public LOMVEW00440()
        {
        ...
        private ILOMCTL00440 controller;
        public ILOMCTL00440 Controller
        {
            set
            {
        ...
        private void LOMVEW00440_Load(object sender, EventArgs e)
        {
