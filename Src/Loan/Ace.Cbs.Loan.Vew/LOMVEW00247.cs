...
{
    public partial class LOMVEW00247 : BaseForm, ILOMVEW00239
    {
        ...
        private void LOMVEW00247_Load(object sender, EventArgs e)
        {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "HPInterestPrepaidList";

            LOMDTO00242 dto = new LOMDTO00242();
            dto.StartDate = StartDate;
            dto.EndDate = EndDate;
            dto.Currency = Currency;
            dto.SourceBr = SourceBr;
            dto.rptName = rptName;
            dto.StockGroupCode = StockGroup;
            dto.storedName = storedName;
            dto.searchByOpt = searchByOpt;
        ...
        private void OptByMonth_Click(object sender, EventArgs e)
        {
