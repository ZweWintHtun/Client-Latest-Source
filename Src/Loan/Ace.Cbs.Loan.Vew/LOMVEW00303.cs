...
{
    public partial class LOMVEW00303 : BaseForm,ILOMVEW00303
    {
        ...
        {
            get { return this.dtpDueDate.Value; }
            set { this.dtpDueDate.Text = value.ToString(); }
        }
        ...
        #region Controller
        private ILOMCTL00303 controller;
        public ILOMCTL00303 Controller
        {
        ...
        private void InitailizeControls()
        {
            ...
            this.dtpDueDate.Value = DateTime.Now;
            this.BindCurrency();
        ...
        #region Events
        private void LOMVEW00303_Load(object sender, EventArgs e)
        {
