...
{
    public partial class LOMVEW00227 : BaseForm, ILOMVEW00227
    {
        public bool status;
        public LOMVEW00227()
        {
        ...
        private ILOMCTL00227 controller;
        public ILOMCTL00227 Controller
        {
            set
            {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "HPAutoPaySufficientLists";

            this.controller.Print(rptName, StartDate, EndDate, Currency, SourceBr, StockGroup);
        }

        private void LOMVEW00227_Load(object sender, EventArgs e)
        {
