...
{
    public partial class LOMVEW00043 : BaseForm
    {
        ...
        public LOMVEW00043(IList<LOMDTO00035> dataList, string startDate, string endDate, string currency,
        ...
        private void LOMVEW00043_Load(object sender, EventArgs e)
        {
            ...
            ReportDataSource dataset = new ReportDataSource("DSLOMRDLC00004", this.DataList);
