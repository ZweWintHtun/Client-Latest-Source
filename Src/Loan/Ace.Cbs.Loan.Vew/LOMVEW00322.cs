...
{
    public partial class LOMVEW00322 : BaseForm, ILOMVEW00322
    {
        #region Constructor
        public LOMVEW00322()
        {
        ...
        #region Controller
        private ILOMCTL00322 controller;
        public ILOMCTL00322 Controller
        {
        ...
        public string CompanyName
        {
            get
            {
                if (this.cboCompanyName.SelectedValue == null)
                {
                    return null;
                }
                else
                {
                    return this.cboCompanyName.SelectedValue.ToString();
                }

            }
            set { this.cboCompanyName.SelectedValue = value.ToString(); }
        }
        ...
        private void InitailizeControls()
        {
            ...
            this.BindCompanyName();
            this.cboCompanyName.Focus();
        ...
        {            
            IList<LOMDTO00316> CompanyNameList = CXClientWrapper.Instance.Invoke<ILOMSVE00316, IList<LOMDTO00316>>(x => x.SelectCompanyName());
        ...
        private void LOMVEW00322_Load(object sender, EventArgs e)
        {
