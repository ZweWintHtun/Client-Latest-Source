...
namespace Ace.Cbs.Mnm.Sve 
{
    public class MNMSVE00054 : BaseService , IMNMSVE00054
    {
        ...
        public IList<MNMDTO00054> GetReportData(PFMDTO00042 dataDTO,int workStationId,int createdUserId)
        {
            ...
            MNMDTO00010 GetHOBalAndCBal = this.GetHOBaLAndCBalForSubLedger_DomesticSVE(dataDTO);
        ...
        public MNMDTO00010 GetHOBaLAndCBalForSubLedger_DomesticSVE(PFMDTO00042 dataDTO)
        {
            ...
            //string budYear1 = CXCOM00010.Instance.GetBudgetYear4(CXCOM00009.BudgetYearCode, dataDTO.StartDate).ToString();
            string budYear = CXCOM00010.Instance.GetBudgetYear1(CXCOM00009.BudgetYearCode);            
        ...
        public IList<MNMDTO00054> GetLedgerListing(PFMDTO00042 dataDTO,int workStatiionId)
        {
            ...
            if (dataDTO.IsHomeCurrency)
            {
                ...
                {
                    PrintDataLists = ViewDAO.GetLedgerListingRptByTDate(dataDTO.StartDate, dataDTO.EndDate,workstation,sourcebr);
                }
