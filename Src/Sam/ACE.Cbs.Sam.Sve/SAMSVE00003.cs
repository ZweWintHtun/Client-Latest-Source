...
namespace Ace.Cbs.Sam.Sve
{
    ...
    public class SAMSVE00003 : BaseService, ISAMSVE00003
    {
        ...
        {
            //return this.occupationCodeDAO.SelectAll(); // Comment By AAM (08-Jan-2018).
            
            return this.occupationCodeDAO.SelectAll().OrderBy(x => Convert.ToInt32(x.Occupation_Code)).ToList();// Added By AAM (08-Jan-2018)
        }
