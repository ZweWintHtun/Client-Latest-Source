...
{
    public partial class LOMVEW00210 : BaseForm, ILOMVEW00210
    {
        public bool status;
        public LOMVEW00210()
        {
        ...
        private ILOMCTL00210 controller;
        public ILOMCTL00210 Controller
        {
            set
            {
        ...
        private void LOMVEW00210_Load(object sender, EventArgs e)
        {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "HPInformationList";
            this.controller.Print(rptName, StartDate, EndDate, StockGroup,SourceBr);
        }
