...
{
    public partial class CBMVEW00006 : BaseForm
    {
        public CBMVEW00006()
        {
            InitializeComponent();
        ...
        public CBMVEW00006(IList<PFMDTO00042> list, DateTime date)
        {
            this.DTOList = list;
            this.Date = date;
            InitializeComponent();
        ...
        {
            this.Text = "Daily Progress Statement Report";
            ...
            ReportDataSource dataset = new ReportDataSource("DailyProgressDS", DTOList);
