...
{
    [Serializable]
    public class LOMDTO00093 : Supportfields<LOMDTO00093>
    {
        public LOMDTO00093() { }

        public LOMDTO00093(DateTime startDate, DateTime endDate, string sourceBranch, string currency,string loanType)
        {
        ...
        public LOMDTO00093(DateTime startDate, DateTime endDate, string sourceBranch, string currency,string seasonType, string loanType)
        {
            this.StartDate = startDate;
            this.EndDate = endDate;
            this.SourceBr = sourceBranch;
            this.Cur = currency;
            this.SeasonDesp = seasonType;
            this.LoanType = loanType;
        }

        public LOMDTO00093(string sourceBranch, string currency,string cropType, string loanType,DateTime startDate, DateTime endDate)
        {
            this.StartDate = startDate;
            this.EndDate = endDate;
            this.SourceBr = sourceBranch;
            this.Cur = currency;
            this.CropDesp = cropType;
            this.LoanType = loanType;
        }

        public LOMDTO00093(string name, string fatherName, string lno, string village,
            string seasonType, string businessType, string loanProductType, string groupNo,
