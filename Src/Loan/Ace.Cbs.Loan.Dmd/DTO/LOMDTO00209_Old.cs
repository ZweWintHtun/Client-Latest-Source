...
namespace Ace.Cbs.Loan.Dmd.DTO
{
    ...
    public class LOMDTO00209 : EntityBase<LOMDTO00209>
    {
        ...
        public LOMDTO00209(string hpNo, string name,string address,string phoneno, string acctNo, decimal loanAmount, int term, DateTime regDate, DateTime expDate, string dealerName, string stockGroup,string nrc)//,string phone
        {
            HPNo = hpNo;
            NAME = name;
