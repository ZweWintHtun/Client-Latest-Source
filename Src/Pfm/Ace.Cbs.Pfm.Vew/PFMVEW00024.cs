...
{
    public partial class frmPFMVEW00024 : BaseForm
    {
        public PFMDTO00059 entityDTO { get; set; }
        public frmPFMVEW00024()
        {
            InitializeComponent();
        }
        public frmPFMVEW00024(PFMDTO00059 entityDTO)
        {
            InitializeComponent();
            this.entityDTO = entityDTO;
        }
        private void frmPFMVEW00024_Load(object sender, EventArgs e)
        {
            if (this.entityDTO != null)
            {
                ...
                param[3] = new ReportParameter("Amount", entityDTO.Amount);
                ...
                param[7] = new ReportParameter("OLSAccountNo", entityDTO.OLSACNo);
                param[8] = new ReportParameter("BankName", entityDTO.BankName);
                param[9] = new ReportParameter("AmountWithZawGyi", this.ThousandSeparator(entityDTO.AmountWithZawGyi).ToString() + ".၀၀");
                ...
                param[10] = new ReportParameter("BankLogo", "file:////" + tempFilePath);
