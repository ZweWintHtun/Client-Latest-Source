//----------------------------------------------------------------------
// <copyright file="TLMCTL00048.cs" company="ACE Data Systems">
...
{
    public class TLMCTL00048 : AbstractPresenter, ITLMCTL00048
    {
        #region Properties
        ...
        {
            this.iblTLFList = CXClientWrapper.Instance.Invoke<ITLMSVE00048, IList<TLMDTO00004>>(x => x.HomeIncomeListingByAllBranch(this.view.StartDate, this.view.EndDate,CurrentUserEntity.BranchCode,this.view.BranchCode ));
        ...
        {
            this.iblTLFList = CXClientWrapper.Instance.Invoke<ITLMSVE00048, IList<TLMDTO00004>>(x => x.ActiveIncomeListingByAllBranch(this.view.StartDate, this.view.EndDate, CurrentUserEntity.BranchCode,this.view.BranchCode));
