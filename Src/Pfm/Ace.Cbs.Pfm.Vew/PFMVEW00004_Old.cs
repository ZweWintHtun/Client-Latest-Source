...
namespace Ace.Cbs.Pfm.Vew
{
    ...
    public partial class frmPFMVEW00004 : BaseDockingForm, IPFMVEW00004
    {
        ...
        private void InitializeControls()
        {
            ...
            this.dtpDOB.Value = DateTime.Now.AddYears(-10); 
            this.txtNRC.Enabled = true;
        ...
        private void RefreshControls()
        {
            ...
            else if (this.FormState == FormState.Edit)
            {
                ...
                //butCustomerSearch.Visible = true;
        ...
        {
            if (this.DateOfBirth < DateTime.Now.AddYears(-18))//18+
            {
                this.viewData.NRCCheckStatus = true;
            }
            else
        ...
        private void cboStateCode_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
