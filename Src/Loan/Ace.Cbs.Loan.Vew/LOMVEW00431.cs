...
{
    public partial class LOMVEW00431 : BaseForm , ILOMVEW00431
    {
        #region Constructor
        public LOMVEW00431()
        {
        ...
        private ILOMCTL00431 controller;
        public ILOMCTL00431 Controller
        {
            set
            {
        ...
        #region Events
        private void LOMVEW00431_Load(object sender, EventArgs e)
        {
        ...
        public void GetRequireCustomerType()
        {
            ...
            else if (OptExternalCust.Checked == true)
            {
                ...
                this.cboACTypes.SelectedValue = "";
                this.rptName = "rptExternalCustomer";
                TypeofCust = true;
            }
        }
        #endregion
