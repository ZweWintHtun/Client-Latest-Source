...
{
    public partial class LOMVEW00036 : BaseForm
    {
        #region "Properties"
        ...
        #region Events
        private void LOMVEW00036_Load(object sender, EventArgs e)
        {
            this.BindLoanProduct();
            this.Text = "Overdraft Rregistration Listing";                
        ...
        {
            CXUIScreenTransit.Transit("frmLOMVEW00035", true, new object[] { typeName });
        }
        #endregion
