...
{
    public class LOMCTL00312 : AbstractPresenter, ILOMCTL00312
    {
        private ILOMVEW00312 view;
        public ILOMVEW00312 View
        {
            get { return this.view; }
            set { this.WireTo(value); }
        }

        private void WireTo(ILOMVEW00312 view)
        {
            if (this.view == null)
            {
                this.view = view;
        ...
        public string PLMonthlyAutoPaymentProc(string sourceBr, int createdUserId, string userName)
        {
            ...
            DateTime GetLateFeeDate = CXCOM00011.Instance.GetScalarObject<DateTime>("Sys001.SelectSettlementDate", new object[] { "PLMonthly_AutoPay", sourceBr, true });
            ...
            string str = CXClientWrapper.Instance.Invoke<ILOMSVE00311, string>(x => x.PLMonthlyAutoPaymentProc(sourceBr, createdUserId, userName, dvcvList));
            return str;
        }
