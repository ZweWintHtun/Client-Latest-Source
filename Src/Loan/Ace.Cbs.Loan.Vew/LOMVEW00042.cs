...
{
    public partial class LOMVEW00042 : BaseForm, ILOMVEW00042
    {
        #region Properties
        ...
        #region Controller
        private ILOMCTL00042 controller;
        public ILOMCTL00042 Controller
        {
        ...
        #region Events
        private void LOMVEW00042_Load(object sender, EventArgs e)
        {
            this.tsbCRUD.ButtonEnableDisabled(false, false, false, false, true, true, true);
            if (this.FormName.Equals("LoansAccountCloseListing.All"))
            {
                this.Text = "Loans Account Close Listing (All)";
                this.ParentFormName = "Loans Account Close Listing (All)";
            }
            else if (this.FormName.Equals("LoansAccountCloseListing.LoansOnly"))
            {
                this.Text = "Loans Account Close Listing (Loans Only)";
                this.ParentFormName = "Loans Account Close Listing (Loans Only)";
            }
            else
            {
                this.Text = "Loans Account Close Listing (OD Only)";
                this.ParentFormName = "Loans Account Close Listing (OD Only)";
            }
