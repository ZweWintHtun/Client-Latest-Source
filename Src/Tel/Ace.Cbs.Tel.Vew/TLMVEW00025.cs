    ...
    public partial class TLMVEW00025 : BaseDockingForm, ITLMVEW00025
    {
        ...
        public void InitializeControls()
        {
            ...
            else if (this.depositName == "DepositListingByCounterNo")
            {
                ...
                //this.dtpStartDate.Focus();
                this.Text = "Deposit Listing (By User No)";
                ...
                || this.depositName == "Deposit Listing By Account Type (Saving)" || this.depositName == "Deposit Listing By Account Type (Fixed)")
            {
                switch (this.depositName)
                {
                    ...
                    case "Deposit Listing By Account Type (Business Loans)": this.Text = "Deposit Listing (By Account Type - Business Loans)";
                        break;
                    case "Deposit Listing By Account Type (HirePurchase)": this.Text = "Deposit Listing (By Account Type - HirePurchase)";
                        break;
                    case "Deposit Listing By Account Type (Personal Loans)": this.Text = "Deposit Listing (By Account Type - Personal Loans)";
                        break;
                    case "Deposit Listing By Account Type (Dealer)": this.Text = "Deposit Listing (By Account Type - Dealer)";
                        break;
                }
