            ...
            try
            {
                ...
                if (Mthyear == sysmonth && Mthstatus == "B")
                {
                    ...
                    if (Mthyear.Substring(0,2) == "03")
                    {
                        ...
                        Prev_PODAO.FormatDefinitionMaxValueUpdate(SourceBranchCode, UpdatedUserID);

                        this.ServiceResult.ErrorOccurred = false;
                        //this.ServiceResult.MessageCode = "MI30031";//Yearly Closing Finished
                        this.MessageList.Add("MI30031");//Yearly Closing Finished
