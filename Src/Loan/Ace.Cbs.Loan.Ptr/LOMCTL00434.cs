...
{
    public class LOMCTL00434 : AbstractPresenter, ILOMCTL00434
    {
        private ILOMVEW00434 view;
        public ILOMVEW00434 View
        {
            get { return this.view; }
            set { this.WriteTo(value); }
        }
        private void WriteTo(ILOMVEW00434 view)
        {
            if (this.view == null)
            {
                this.view = view;
        ...
        public void Print()
        {
            ...
            BlackListData = CXClientWrapper.Instance.Invoke<ILOMSVE00427, IList<LOMDTO00427>>(x => x.GetAllBlackListHistoryByACTypeAndDate(this.View.TypeofCust, this.View.AccountType, this.View.StartDate, this.View.EndDate, this.View.SourceBr));
