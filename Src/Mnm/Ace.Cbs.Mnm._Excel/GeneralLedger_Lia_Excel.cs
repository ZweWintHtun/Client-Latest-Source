...
{
    public class GeneralLedger_Lia_Excel
    {
        public GeneralLedger_Lia_Excel()
        {
      ...
      )
        {
            try
            {
                ...
                string FileName = Path.GetTempPath() + exportFileName + ".xlsx";
                ...
                rng01.Font.Size = 13;
                rng01.EntireRow.Font.Name = "Times New Roman";
                rng01.Font.Bold = true; rng01.Value = result_Income_sheet1_4Line_Title;
                rng01.Value = "For the month of " + requiredDate.ToString("MMMM") + "' " + requiredDate.ToString("yyyy");
                rng01.HorizontalAlignment = XlHAlign.xlHAlignCenter;
                rng01.VerticalAlignment = XlVAlign.xlVAlignCenter;

                rng01 = myworksheet.get_Range("A5:F5");
                rng01.MergeCells = true;
                rng01.Value = "ASSETS";
                rng01.Font.Size = 13;
                rng01.EntireRow.Font.Name = "Times New Roman";
                ...
                rng01 = myworksheet.get_Range("A6:A7");
                rng01.MergeCells = true;
                rng01.WrapText = true;
                rng01.Value = "Sr. No";
                rng01.Font.Size = 12;
                ...
                rng01 = myworksheet.get_Range("B6:B7");
                rng01.MergeCells = true;
                rng01.Value = "Assets";
                rng01.Font.Size = 12;
                rng01.EntireRow.Font.Name = "Times New Roman";
                ...
                rng01 = myworksheet.get_Range("C6:C7");
                rng01.MergeCells = true;
                rng01.WrapText = true;
                ...
                rng01 = myworksheet.get_Range("D6:D7");
                rng01.MergeCells = true;
                rng01.WrapText = true;
                ...
                rng01 = myworksheet.get_Range("E6:E7");
                rng01.MergeCells = true;
                rng01.WrapText = true;
                ...
                rng01 = myworksheet.get_Range("F6:F7");
                rng01.MergeCells = true;
                rng01.WrapText = true;
                ...
                rng01 = myworksheet.get_Range("A6:F7");
                rng01.HorizontalAlignment = XlHAlign.xlHAlignCenter;
                rng01.VerticalAlignment = XlVAlign.xlVAlignCenter;

                rng01 = myworksheet.get_Range("B:F");
                ...
                rng01 = myworksheet2.get_Range("A5:F5");
                rng01.MergeCells = true;
                ...
                rng01 = myworksheet2.get_Range("A6:A7");
                rng01.MergeCells = true;
                rng01.Font.Size = 12;
                rng01.EntireRow.Font.Name = "Times New Roman";
                rng01.Font.Bold = true;
                ...
                rng01 = myworksheet2.get_Range("B6:B7");
                rng01.MergeCells = true;
                rng01.Font.Size = 12;
                rng01.EntireRow.Font.Name = "Times New Roman";
                rng01.Font.Bold = true;
                ...
                rng01 = myworksheet2.get_Range("C6:C7");
                rng01.MergeCells = true;
                rng01.Font.Size = 12;
                rng01.EntireRow.Font.Name = "Times New Roman";
                rng01.Font.Bold = true;
                ...
                rng01 = myworksheet2.get_Range("D6:D7");
                rng01.MergeCells = true;
                rng01.Font.Size = 12;
                rng01.EntireRow.Font.Name = "Times New Roman";
                rng01.Font.Bold = true;
                ...
                rng01 = myworksheet2.get_Range("E6:E7");
                rng01.MergeCells = true;
                rng01.Font.Size = 12;
                rng01.EntireRow.Font.Name = "Times New Roman";
                rng01.Font.Bold = true;
                ...
                rng01 = myworksheet2.get_Range("F6:F7");
                rng01.MergeCells = true;
                rng01.Font.Size = 12;
                rng01.EntireRow.Font.Name = "Times New Roman";
                rng01.Font.Bold = true;
                ...
                rng01 = myworksheet2.get_Range("A6:F7");
                rng01.Borders.Color = System.Drawing.Color.Black.ToArgb();
                ...
                for (int i = 0; i < list2.Count; i++)
                {
                    ...
                    if (_ReplaceAllString(title_Name) == _ReplaceAllString(titleName))
                    {
                        ...
                        rng01.Borders[XlBordersIndex.xlEdgeRight].LineStyle = XlLineStyle.xlContinuous;
                        rng01.Font.Size = 12;
                        rng01.Font.Name = "Times New Roman";
                        ...
                        rng01.Value = list2[i].Closing_bal.ToString();
                        //rng01.NumberFormat = "#,##0.00.00";
                        rng01.NumberFormat = "#,##0.00;(#,##0.00)";
                        rng01.Borders[XlBordersIndex.xlEdgeLeft].LineStyle = XlLineStyle.xlContinuous;
                        rng01.Borders[XlBordersIndex.xlEdgeRight].LineStyle = XlLineStyle.xlContinuous;
                ...
                rngSubTotal.Font.Name = "Times New Roman";
                ...
                //myworkbook.SaveAs(FileName, Excel.XlFileFormat.xlOpenXMLWorkbook, misValue, misValue, misValue, misValue, Excel.XlSaveAsAccessMode.xlNoChange, Excel.XlSaveConflictResolution.xlUserResolution, misValue, misValue, misValue, misValue);
               // myworkbook.SaveAs(FileName, Excel.XlFileFormat.xlExcel12, misValue, misValue, misValue, misValue, Excel.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
                ...
                myworkbook.SaveAs(FileName, Excel.XlFileFormat.xlWorkbookDefault, Type.Missing, Type.Missing, true, false, XlSaveAsAccessMode.xlNoChange, XlSaveConflictResolution.xlLocalSessionChanges, Type.Missing, Type.Missing);
