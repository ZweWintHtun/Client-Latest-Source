...
namespace Ace.Cbs.Cx.Ser.Sve
{
    ...
    public class CXSVE00002 : BaseService, ICXSVE00002
    {
        ...
        public string GetGenerateCode(string formatCode, string checkDigitFormula, int updatedUserId,string branchCode, params dynamic[] inputFormatDefinition)
        {
            ...
            try
            {
                if (formatCode != null || formatCode.Trim() != string.Empty)
                {
                    ...
                    IList<FormatDefinition> formatDefinitionList = this.codeGeneratorDAO.SelectFormatDefinitonByFormatCode(formatCode,branchCode.Trim());
        ...
        public void UpdateFormatDefinition(string formatCode, string branchCode)
        {
         ...
         IList<FormatDefinition> formatDefinitionList = this.codeGeneratorDAO.SelectFormatDefinitonByFormatCode(formatCode, branchCode);
          int id =formatDefinitionList[0].FormatId; 
          string maxvalue = "0";
          int UpdatedUserId = Convert.ToInt32(formatDefinitionList[0].UpdatedUserId);
         DateTime UpdatedDate = System.DateTime.Now;
         this.codeGeneratorDAO.FormatDefinitionUpdateForLoanReg(id, maxvalue, branchCode, UpdatedUserId,UpdatedDate);
        ...
        [Transaction(TransactionPropagation.Required)]
        public string GenerateCodeForLoanGroupNo(string formatCode, int updatedUserId, string branchCode, params dynamic[] inputFormatDefinition)
        {
            string code = string.Empty;
            try
            {
        ...
        [Transaction(TransactionPropagation.Required)]
        public string GenerateLoanRecordVouncher(string formatCode, int updatedUserId, string branchCode, params dynamic[] inputFormatDefinition)
        {
            string code = string.Empty;
            try
            {
