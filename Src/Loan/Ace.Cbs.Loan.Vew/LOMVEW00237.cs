...
{
    public partial class LOMVEW00237 : BaseForm, ILOMVEW00235
    {
        public LOMVEW00237()
        {
            InitializeComponent();
        ...
        private void LOMVEW00237_Load(object sender, EventArgs e)
        {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "BLAccountClosedLists";
            this.controller.Print_BL_AccountClosed_Listing(rptName, StartDate, EndDate, Currency, SourceBr);
        }
