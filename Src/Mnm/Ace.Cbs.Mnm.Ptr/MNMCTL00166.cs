...
namespace Ace.Cbs.Mnm.Ptr
{
    ...
    public class MNMCTL00166 : AbstractPresenter, IMNMCTL00166
    {
        #region Properties
        ...
        #region VIEW
        private IMNMVEW00166 view;
        public IMNMVEW00166 View
        {
            get { return this.view; }
            set { this.WireTo(value); }
        }

        private void WireTo(IMNMVEW00166 view)
        {
            this.view = view;
           ...
           ValidationStatus = false;
            ...
            //{
                if (this.view.GroupNo != string.Empty)
                {
                    ...
                    if (!string.IsNullOrEmpty(status) && TotalAmount != 0)
                    {
                        ...
                        //{
                            ...
                            //{
                                ...
                                CashDenoDTO.AdjustAmount = Convert.ToDecimal(0.00);
                    ...
                    CashDenoDTO.Amount = this.View.Amount;
                    string voucherNo = CXClientWrapper.Instance.Invoke<IMNMSVE00166, string>(x => x.Save_Reversal(this.View.EntryNo, this.view.GroupNo, CurrentUserEntity.CurrentUserID, CurrentUserEntity.BranchCode, CashDenoDTO));
                    //ZMS//CXClientWrapper.Instance.Invoke<IMNMSVE00166>(x => x.Save_Reversal(this.view.EntryNo, this.view.GroupNo, CurrentUserEntity.CurrentUserID, CurrentUserEntity.BranchCode, CashDenoDTO));
        ...
        {            
            IList<PFMDTO00043> GetPrnFileList = CXClientWrapper.Instance.Invoke<IMNMSVE00166, IList<PFMDTO00043>>(x => x.SelectPrnFileByAccountNo(accountNo));            
            try
            {
        ...
        public void GetEntryData()
        {
            ...
            string GroupNo = this.View.GroupNo;
            try
            {
                IList<PFMDTO00001> customerInformation = new List<PFMDTO00001>();
                //Check Entry no from Tlf
                IList<PFMDTO00054> ListTlfDTO = CXClientWrapper.Instance.Invoke<IMNMSVE00166, PFMDTO00054>(x => x.Check_EntryNo_Valid(GroupNo, EntryNo, CurrentUserEntity.BranchCode));
                
                //if (ListTlfDTO != null)
                if (ListTlfDTO.Count > 0)
                {
                    //if (ListTlfDTO[0].DateTime.ToString("dd/MM/yyyy") == DateTime.Now.ToString("dd/MM/yyyy"))
                    //{
                        if (this.view.GroupNo != "" && this.view.GroupNo == ListTlfDTO[0].GroupNo)
                        {
                            ...
                            {
                                customerInformation = CXClientWrapper.Instance.Invoke<ICXSVE00006, IList<PFMDTO00001>>(x => x.GetCustomerInfomationByAccountNo(this.accountNo, false));
                                this.acSign = customerInformation[0].AccountSign;
                            }
                            //TotalAmount = ListTlfDTO[0].DenoAmount;
                            //decimal TotaGroupAmount = CXClientWrapper.Instance.Invoke<IMNMSVE00166, decimal>(x => x.SelectGroupAmountForMultipleReversal(this.view.GroupNo, CurrentUserEntity.BranchCode));

                            TotalAmount = Convert.ToDecimal(ListTlfDTO[0].TotalGroupAmount) - Convert.ToDecimal(ListTlfDTO[0].HomeAmt);
                            SourceCurrency = ListTlfDTO[0].SourceCurrency;
                            this.AcType = ListTlfDTO;
                            this.View.Amount = ListTlfDTO[0].Amount;
                        }
                }
                else
                {
                    this.SetCustomErrorMessage(this.GetControl("txtEntryNo"), CXMessage.MV00213);//Invalid Entry No.
                }
                ...
                {
                    this.View.FillData(ListTlfDTO, customerInformation);
                }               
            }            
            catch (Exception ex)
            {
        ...
        {
            return CXClientWrapper.Instance.Invoke<IMNMSVE00166, string>(x => x.Check_GroupNo_ValidOrNot_MultipleDepReversal(groupNo, sourceBr));
        }

        //Added by AAM(22-Jan-2018)
        //Commented by HMW (10-June-2019)
        //public string Check_EntryNo_ValidOrNot_MultipleDepReversal(string eno, string sourceBr)
        //{
        //    return CXClientWrapper.Instance.Invoke<IMNMSVE00166, string>(x => x.Check_EntryNo_ValidOrNot_MultipleDepReversal(eno,sourceBr,this.View.GroupNo));
        //}
        
        //Added by HMW (10-June-2019)
        public string Check_EntryNo_ValidOrNot_MultipleDepWdwReversal(string eno, string sourceBr)
        {
            return CXClientWrapper.Instance.Invoke<IMNMSVE00166, string>(x => x.Check_EntryNo_ValidOrNot_MultipleDepWdwReversal(this.View.GroupNo, eno, sourceBr));
        }
