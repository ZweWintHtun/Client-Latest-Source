...
{
    public partial class LOMVEW00235 : BaseForm, ILOMVEW00235
    {
        public LOMVEW00235()
        {
            InitializeComponent();
        ...
        private ILOMCTL00235 controller;
        public ILOMCTL00235 Controller
        {
            set
            {
        ...
        private void LOMVEW00235_Load(object sender, EventArgs e)
        {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "HPAccountClosedLists";
            this.controller.Print_HP_AccountClosed_Listing(rptName, StartDate, EndDate, Currency, SourceBr);
        }
