...
{
    public partial class LOMVEW00209 : BaseForm, ILOMVEW00209
    {
        public bool status;
          public LOMVEW00209()
        {
        ...
        private ILOMCTL00209 controller;
        public ILOMCTL00209 Controller
        {
            set
            {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "HPDailyPositionList";
            
            //this.controller.Print(rptName, StockGroup,StartDate,EndDate, SourceBr);
            this.controller.Print(rptName, StockGroup, SourceBr);
        }

        private void LOMVEW00209_Load(object sender, EventArgs e)
        {
