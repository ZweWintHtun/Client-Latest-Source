...
namespace Ace.Cbs.Loan.Ctr.Dao
{
    public interface ILOMDAO00311 : IDataRepository<LOMORM00311>
    {
        ...
        //Endregion
        string PLLateFeesAutoPayVoucherProcess(string sourceBr, int createdUserId, string userName);//Added by HWKO (16-Oct-2017)
        ...
        string Save_PLInfoRegisterEdit_ByAcctNo(string acctNo, string sourceBr, string companyName, string guaCompanyName
                                                       , string guaName, string guaNRC, string guaPhone, int createdUserId);//Added by AAM (22-May-2017)
    }
}
