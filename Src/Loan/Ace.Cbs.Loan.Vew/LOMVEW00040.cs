...
{
    public partial class LOMVEW00040 : BaseForm, ILOMVEW00040
    {
        #region Contructor
        public LOMVEW00040()
        {
        ...
        public LOMVEW00040(string typeName)
        {
        ...
        #region Controller
        private ILOMCTL00040 controller;
        public ILOMCTL00040 Controller
        {
        ...
        #region Events
        private void LOMVEW00040_Load(object sender, EventArgs e)
        {
            this.tsbCRUD.ButtonEnableDisabled(false, false, false, false, true, true, true);
            switch (this.ParentFormName)
            {
                case "LB":
                    this.Text = "Loans and Overdraft Registration Listing (Lands and Building)";
                    break;
                case "PG":
                    this.Text = "Loans and Overdraft Registration Listing (Personal Guarantee)";
                    break;
                case "PL":
                    this.Text = "Loans and Overdraft Registration Listing (Pledge)";
                    break;
                case "HP":
                    this.Text = "Loans and Overdraft Registration Listing (Hypothecation)";
                    break;
                case "GJ":
                    this.Text = "Loans and Overdraft Registration Listing (Gold and Jewellery)";
                    break;
                case "All":
                    this.Text = "Loans and Overdraft Registration Listing (All)";
                    break;
            }
