...
{
    public partial class MNMVEW00091 : BaseForm
    {
        #region Property
        ...
        public IMNMCTL00091 Controller { get; set; }
        ...
        public MNMVEW00091(IList<MNMDTO00010> trialList,string branchno,string cur,string formName,string month)
        {
        ...
        private void MNMVEW00091_Load(object sender, EventArgs e)
        {
            ...
            ReportDataSource dataset = new ReportDataSource("TrialDetail", transactionlist);
