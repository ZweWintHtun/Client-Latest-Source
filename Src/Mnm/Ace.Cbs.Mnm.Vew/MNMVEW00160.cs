//----------------------------------------------------------------------
// <copyright file="MNMVEW00160.cs" company="ACE Data Systems">
...
{
    ///Closing -->Monthly Closing-->Encash Remittance Report Viewer
    public partial class MNMVEW00160 : BaseDockingForm
    {       
        #region "Properties"
        private string TransactionStatus { get; set; }       
        private string BranchNo { get; set; }     
        public IList<TLMDTO00001> DrawingEncashRemittanceDTOLists { get; set; }
        #endregion
        ...
        public MNMVEW00160(IList<TLMDTO00001> DEDTOLists, string screenName)
        {           
        ...
        #region Event
        private void MNMVEW00160_Load(object sender, EventArgs e)
        {
            try
            {
                if (this.DrawingEncashRemittanceDTOLists.Count > 0)
                {
                    TLMDTO00001 WithdrawlListingDTO = new TLMDTO00001();
                    ...
                    WithdrawlListingDTO.PhoneNo = Branch.Phone;
                    ...
                    para[2] = new ReportParameter("Phone", WithdrawlListingDTO.PhoneNo);
                    ...
                    ReportDataSource dataset = new ReportDataSource("EncashRemittanceClosingDataSet", DrawingEncashRemittanceDTOLists);
        ...
        private void MNMVEW00160_FormClosing(object sender, FormClosingEventArgs e)
        {
