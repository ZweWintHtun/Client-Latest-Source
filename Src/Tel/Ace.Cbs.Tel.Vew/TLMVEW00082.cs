...
{
    public partial class TLMVEW00082 : BaseForm
    {
        ...
        public TLMVEW00082(string account, decimal amount, string naration,string voucherNo)
        {
            InitializeComponent();
        ...
        private void TLMVEW00082_Load(object sender, EventArgs e)
        {
            this.rpvDomesticCreditVoucher.LocalReport.DataSources.Clear();

            string crcashlogoPath = Application.StartupPath + "\\CreditCash.png";
            ...
            param[0] = new ReportParameter("CreditCashLogo", "file:////" + crcashlogoPath);
            ...
            param[6] = new ReportParameter("Narration", this.Naration.ToString());
            ...
            this.rpvDomesticCreditVoucher.LocalReport.EnableExternalImages = true;
            this.rpvDomesticCreditVoucher.LocalReport.SetParameters(param);
            this.rpvDomesticCreditVoucher.SetDisplayMode(DisplayMode.PrintLayout);
            this.rpvDomesticCreditVoucher.RefreshReport();

            //this.rpvDomesticCreditVoucher.SetDisplayMode(DisplayMode.PrintLayout);
            //this.rpvDomesticCreditVoucher.ZoomMode = ZoomMode.FullPage;
            //this.rpvDomesticCreditVoucher.ZoomPercent = 75;
            //this.rpvDomesticCreditVoucher.RefreshReport();
        }
