...
{
    public partial class LOMVEW00435 : BaseDockingForm, ILOMVEW00435
    {
        ...
        private ILOMCTL00435 controller;
        public ILOMCTL00435 Controller
        {
            set
            {
        ...
        private void LOMVEW00435_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void tsbCRUD_SaveButtonClick(object sender, EventArgs e)
        {
            ...
            {
                string result = this.Controller.SaveWarningLists(CurrentUserEntity.CurrentUserID, CurrentUserEntity.BranchCode, DOB);
                if (result == "0000")
                {
                ...
                {
                    CXUIMessageUtilities.ShowMessageByCode(CXMessage.MV90230);//This customer is already in Black List.
                    InitializeControls();
                }
            }
            else
