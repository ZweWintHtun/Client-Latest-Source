...
namespace Ace.Cbs.Loan.Dmd
{
    ...
    ///
    [Serializable]
    public class LOMDTO00307 : Supportfields<LOMDTO00307>
    {
        public LOMDTO00307() { }

        public LOMDTO00307(int id, DateTime repaymentDate,string lno,string repayNo,string villageCode,
        ...
        public LOMDTO00307(DateTime startDate,DateTime endDate, string cur, string sourceBr)
        {
