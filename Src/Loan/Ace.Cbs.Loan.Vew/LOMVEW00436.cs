...
{
    public partial class LOMVEW00436 : BaseDockingForm, ILOMVEW00436
    {
        ...
        private ILOMCTL00436 controller;
        public ILOMCTL00436 Controller
        {
            set
            {
        ...
        private void btnApprove_Click(object sender, EventArgs e)
        {
            ...
            string result = this.Controller.SaveWarningListsApproveReject();
            if (result == "000")
            {
                //CXUIMessageUtilities.ShowMessageByCode(CXMessage.MV90231);//Warning List Customer Approved Successfully!
                CXUIMessageUtilities.ShowMessageByCode(CXMessage.MI90141);//Warning List Customer Approved Successfully!
                InitializeControls();
            }
            else if (result == "111")
            {
        ...
        private void btnReject_Click(object sender, EventArgs e)
        {
            ...
            if (result == "000")
            {
                //CXUIMessageUtilities.ShowMessageByCode(CXMessage.MV90232);//Warning List Customer Reject Successfully!
                CXUIMessageUtilities.ShowMessageByCode(CXMessage.MI90142);//Warning List Customer Reject Successfully!
                InitializeControls();
            }
            else if (result == "111")
            {
        ...
        private void LOMVEW00436_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        public void InitializeControls()
        {
            ...
            idArray = "";
            BlackListsData = this.Controller.SelectAllWarningListsForApproveReject();
