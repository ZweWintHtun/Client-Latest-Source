...
{
    public partial class TLMVEW00080 : BaseDockingForm, ITLMVEW00080
    {
        #region Constrator
        ...
        private ITLMCTL00080 controller;
        public ITLMCTL00080 Controller
        {
            get
            {
        ...
        private void TLMVEW00080_Load(object sender, EventArgs e)
        {
            #region Old_Logic_OK
            ...
            else //Don't show form after cut off
            {
                ...
                this.DisableControls("Deposit.AllDisable");                
            }
            #endregion
        ...
        private void gvDepositInformation_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 1)
            {
            ...
            else if (e.ColumnIndex == 0)
            {
                ...
                this.Amount = decimal.Parse(string.Format("{0:#,##0.00}", double.Parse(depositEntity.Amount.ToString())));
