...
{
    public partial class LOMVEW00310 : BaseForm
    {
        IList<LOMDTO00309> DataList { get; set; }
        ...
        public LOMVEW00310(IList<LOMDTO00309> dataList, string startDate, string endDate, string currency,
        ...
        private void LOMVEW00310_Load(object sender, EventArgs e)
        {
            this.Text = head;
            ...
            ReportDataSource dataset = new ReportDataSource("DSLOMRDLC00025", this.DataList);
