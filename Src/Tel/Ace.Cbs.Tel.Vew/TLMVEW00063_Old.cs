        ...
        private void TLMVEW00063_Load(object sender, EventArgs e)
        {
            ...
            else if (this.DepositName == "DepositListingByCounterNo")
            {
               ...
               // this.list = this.controller.ShowDepositByCounterReport();
                ...
                reporttlfDTO.ReportTitle = "Deposit Listing By Counter (" + this.CounterNo + ") from " + this.StartDate.ToString("dd/MM/yyyy") + " to " + this.EndDate.ToString("dd/MM/yyyy");
            }
            else if(this.ByGradeName == "DepositListingByGrade")
            {
                this.Text = "Deposit Listing (By Grade) ";
                reporttlfDTO.ReportTitle = "Deposit Listing By Amount between "+ this.MinimumAmount.ToString() + " and " + this.MaximumAmount.ToString();
            ...
            else if (this.ByGradeName == "WithdrawListingByGrade")
            {
                ...
                reporttlfDTO.ReportTitle = "Withdraw Listing By Amount between " + this.MinimumAmount.ToString() + " and " + this.MaximumAmount.ToString();
