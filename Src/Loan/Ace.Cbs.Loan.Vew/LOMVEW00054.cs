...
{
    public partial class LOMVEW00054 : BaseForm, ILOMVEW00054
    {
        #region Constructor
        public LOMVEW00054()
        {
        ...
        public LOMVEW00054(string selectedQuater)
        {
        ...
        #region Controller
        private ILOMCTL00054 controller;
        public ILOMCTL00054 Controller
        {
        ...
        #region Events
        private void LOMVEW00054_Load(object sender, EventArgs e)
        {
            this.tsbCRUD.ButtonEnableDisabled(false, false, false, false, true, true, true);
            this.Text = "Overdraft Interest Listing";
