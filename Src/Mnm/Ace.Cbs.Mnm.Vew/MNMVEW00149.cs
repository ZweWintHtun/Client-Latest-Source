...
{
    public partial class MNMVEW00149 : BaseForm
    {
        ...
        public MNMVEW00149(IList<PFMDTO00042> List, DateTime startDate, DateTime endDate, string formName)
        {          
        ...
        private void MNMVEW00149_Load(object sender, EventArgs e)
        {
            ...
            ReportDataSource dataset = new ReportDataSource("POWithdrawlEncashDataSet", PrintDataList);
