...
{
    public partial class LOMVEW00211 : BaseForm, ILOMVEW00211
    {
        public bool status;
        public LOMVEW00211()
        {
        ...
        private ILOMCTL00211 controller;
        public ILOMCTL00211 Controller
        {
            set
            {
        ...
        private void LOMVEW00211_Load(object sender, EventArgs e)
        {
            this.BindCurrency();
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "HPPaymentList";
            this.controller.Print(rptName,StartDate,EndDate,StockGroup, Currency,SourceBr);
        }
