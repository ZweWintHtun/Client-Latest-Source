...
{
    public partial class LOMVEW00055 : BaseForm
    {
        public LOMVEW00055()
        {
            InitializeComponent();
        ...
        private void LOMVEW00055_Load(object sender, EventArgs e)
        {
        ...
        {
            CXUIScreenTransit.Transit("frmLOMVEW00054", true, new object[] { selectedQuater });
        }
    }
}
