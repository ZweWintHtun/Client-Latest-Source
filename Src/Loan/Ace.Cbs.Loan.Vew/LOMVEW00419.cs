...
{
    public partial class LOMVEW00419 : BaseForm, ILOMVEW00419
    {
        ...
        public LOMVEW00419(bool isMainMenu, string parentFormId)
        {
            InitializeComponent();
        ...
        #endregion
        private ILOMCTL00419 controller;
        public ILOMCTL00419 Controller
        {
            set
            {
        ...
        private void LOMVEW00419_Load(object sender, EventArgs e)
        {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "BLAbsentHistoryList";
