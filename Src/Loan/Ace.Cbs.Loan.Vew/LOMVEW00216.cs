...
{
    public partial class LOMVEW00216 : BaseForm, ILOMVEW00216
    {
        ...
        public LOMVEW00216(bool isMainMenu, string parentFormId)
        {
            InitializeComponent();
        ...
        private ILOMCTL00216 controller;
        public ILOMCTL00216 Controller
        {
            set
            {
        ...
        private void LOMVEW00216_Load(object sender, EventArgs e)
        {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "HPAbsentHistoryList";
