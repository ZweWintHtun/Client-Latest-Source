...
{
    public partial class MNMVEW00150 : BaseForm
    {
        #region Properties
        ...
        public MNMVEW00150(IList<PFMDTO00042> List, DateTime startDate, DateTime endDate, string formName)
        {          
        ...
        private void MNMVEW00150_Load(object sender, EventArgs e)
        {
            ...
            PrintDataList[0].ClosingBalance = transferamount;
            this.rpvPOWithdrawlEncash.LocalReport.EnableExternalImages = true;
            this.rpvPOWithdrawlEncash.LocalReport.SetParameters(para);
            ReportDataSource dataset = new ReportDataSource("POWithdrawlEncashTransferDataSet", PrintDataList);
