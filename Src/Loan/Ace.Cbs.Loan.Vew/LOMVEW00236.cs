...
{
    public partial class LOMVEW00236 : BaseForm, ILOMVEW00235
    {
        public LOMVEW00236()
        {
            InitializeComponent();
        ...
        private void LOMVEW00236_Load(object sender, EventArgs e)
        {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "PLAccountClosedLists";
            this.controller.Print_PL_AccountClosed_Listing(rptName, StartDate, EndDate, Currency, SourceBr);
        }
