...
namespace Ace.Cbs.Loan.Dmd
{
    ...
    /// 
    [Serializable]
    public class LOMDTO00001 : Supportfields<LOMDTO00001>
    {
         public LOMDTO00001() { }
        ...
        public LOMDTO00001(string code, string description,string glAcode, bool active, DateTime createdDate, int createdUserId, Nullable<DateTime> updatedDate, Nullable<int> updatedUserId, byte[] ts)
        {
            this.Code = code;
            this.Description = description;
        ...
        public LOMDTO00001(string code, string description, string glAcode, bool active, byte[] ts, DateTime createdDate, int createdUserId, DateTime updatedDate, int updatedUserId)
        {
            this.Code = code;
            this.Description = description;
            this.RelatedGLACode = glAcode;
        ...
        public LOMDTO00001(string code, string description, string glAcode)
        {
            this.Code = code;
            this.Description = description;
            this.RelatedGLACode = glAcode;
