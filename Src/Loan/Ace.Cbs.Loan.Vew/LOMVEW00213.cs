...
{
    public partial class LOMVEW00213 : BaseForm, ILOMVEW00213
    {
        public bool status;
        public LOMVEW00213()
        {
        ...
        private ILOMCTL00213 controller;
        public ILOMCTL00213 Controller
        {
            set
            {
        ...
        public string InterestPaidStatus;
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "HPInterestDuePreList";
            this.controller.Print(rptName, StartDate, EndDate, Currency, SourceBr, StockGroup,InterestPaidStatus);
        }
        ...
        private void LOMVEW00213_Load(object sender, EventArgs e)
        {
        ...
        private void cboIntPaidStatus_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ind == 0) InterestPaidStatus = ""; // "" means ALL.
