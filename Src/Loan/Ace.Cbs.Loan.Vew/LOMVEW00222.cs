...
{
    public partial class LOMVEW00222 : BaseForm, ILOMVEW00222
    {
        public bool status;
        public LOMVEW00222()
        {
        ...
        private ILOMCTL00222 controller;
        public ILOMCTL00222 Controller
        {
            set
            {
        ...
        public bool ValidationControls()
        {
            ...
            if (OptByProductType.Checked == true)
            {
                if (cboProductGroup.SelectedIndex ==0 || cboProductGroup.SelectedIndex ==0)
                {
                    CXUIMessageUtilities.ShowMessageByCode(CXMessage.MV90108); //Product type is required.
                    errorProvider1.Clear();
                    return false;
                }
                return true;
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "HPInstallmentList";

            this.controller.Print(rptName, Currency, SourceBr, StockGroup);
        }

        private void LOMVEW00222_Load(object sender, EventArgs e)
        {
        ...
        private void rdoByHPNo_CheckedChanged(object sender, EventArgs e)
        {
            ChangeView();
        }
        private void ChangeView()
        {
            ...
            else if (rdoByHPNo.Checked == true)
            {
                 this.SortType = "HPNO" ;
            }
        }
