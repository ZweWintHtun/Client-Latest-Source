...
{
    public partial class LOMVEW00233 : BaseForm, ILOMVEW00233
    {
        public LOMVEW00233()
        {
            InitializeComponent();
        ...
        private ILOMCTL00233 controller;
        public ILOMCTL00233 Controller
        {
            set
            {
        ...
        private void LOMVEW00233_Load(object sender, EventArgs e)
        {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "PLLateFeesRepaymentLists";
