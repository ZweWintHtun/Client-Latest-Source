...
{
    public partial class LOMVEW00225 : BaseForm, ILOMVEW00225
    {
        public bool status;
        public LOMVEW00225()
        {
        ...
        private ILOMCTL00225 controller;
        public ILOMCTL00225 Controller
        {
            set
            {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "PLDailyPositionList";

            this.controller.Print(rptName, SourceBr,CompanyName);
        }

        private void LOMVEW00225_Load(object sender, EventArgs e)
        {
