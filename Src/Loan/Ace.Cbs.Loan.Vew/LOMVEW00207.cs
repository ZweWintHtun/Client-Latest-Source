...
{
    public partial class LOMVEW00207 : BaseForm, ILOMVEW00207
    {
        public LOMVEW00207()
        {
            InitializeComponent();
        }
        private ILOMCTL00207 controller;
        public ILOMCTL00207 Controller
        {
            set
            {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "PersonalLoansNPLCaseList";
            this.controller.Print(rptName, StartDate, EndDate);
        }

        private void LOMVEW00207_Load(object sender, EventArgs e)
        {
            InitializeControls();
        }
