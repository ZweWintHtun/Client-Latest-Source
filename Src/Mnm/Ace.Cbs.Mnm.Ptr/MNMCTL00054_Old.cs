    ...
    class MNMCTL00054 : AbstractPresenter, IMNMCTL00054
    {
        ...
        public void Print()
        {
            if (ValidateForm())
            {
                ...
                if (returnCashCode.Substring(1, 3).ToUpper() == this.view.AccountCode.Substring(1, 3).ToUpper())
                {
                ...
                //    DataDTO.Status = "OD";
                //}
                else if (returnODACode1.ToUpper() == this.view.AccountCode.Substring(1, 3).ToUpper())
                {
                    DataDTO.ACode = returnODACode1;
                    DataDTO.Status = "LOANSTOD";
                } 
                else if (returnODACode2.ToUpper() == this.view.AccountCode.Substring(1, 3).ToUpper())
                {
                ...
                PrintDataLists = CXClientWrapper.Instance.Invoke<IMNMSVE00054, IList<MNMDTO00054>>(x => x.GetReportData(DataDTO, CurrentUserEntity.WorkStationId, CurrentUserEntity.CurrentUserID));
                ...
                CXUIScreenTransit.Transit("frmMNMVEW00103", true, new object[] { PrintDataLists, this.view.AccountCode, this.view.StartDate, this.view.EndDate, this.view.Currency });
            }
        }
