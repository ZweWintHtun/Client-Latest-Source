...
{
    public partial class LOMVEW00202 : BaseForm, ILOMVEW00202
    {
        ...
        //public LOMVEW00202(bool isMainMenu, string parentFormId)
        //{
        //    InitializeComponent();
        ...
        private ILOMCTL00202 controller;
        public ILOMCTL00202 Controller
        {
        ...
        private void LOMVEW00202_Load(object sender, EventArgs e)
        {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "HPOverDrawnList";
            this.controller.Print(rptName,SourceBr,Currency,StartDate,EndDate);
        }
