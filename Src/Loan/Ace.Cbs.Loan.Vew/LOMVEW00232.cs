...
{
    public partial class LOMVEW00232 : BaseForm, ILOMVEW00232
    {
        public LOMVEW00232()
        {
            InitializeComponent();
        ...
        private ILOMCTL00232 controller;
        public ILOMCTL00232 Controller
        {
            set
            {
        ...
        private void LOMVEW00232_Load(object sender, EventArgs e)
        {
        ...
        private void tsbCRUD_PrintButtonClick(object sender, EventArgs e)
        {
            if (!this.ValidationControls())
                return;
            string rptName = "HPLateFeesRepaymentLists";
